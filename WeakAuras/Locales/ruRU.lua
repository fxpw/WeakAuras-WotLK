...
L["Hybrid"] = "Гибридная"
L["Icon"] = "Иконка"
L["If you require additional assistance, please open a ticket on GitHub or visit our Discord at https://discord.gg/weakauras!"] = "Если вам необходима дополнительная помощь, пожалуйста, посетите наш сервер в Discord по адресу https://discord.gg/weakauras."
